...
class Academic_Office_home_pageTest9 {
    Connection conn=Main.connect();
    Statement stmt=conn.createStatement();
    Academic_Office_home_page acad=new Academic_Office_home_page();
    Scanner in =new Scanner(System.in);

    Academic_Office_home_pageTest9() throws SQLException {
    }

    @BeforeEach
    void setUp()  {
        String query1="delete from event_table_acads;";
        String query2="insert into event_table_acads values('2020-1','Y','N','0','0');";
        try{
