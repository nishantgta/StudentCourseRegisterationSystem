...
class Faculty_home_pageTest6 {
    ...
    Faculty_home_pageTest6() throws SQLException {
    }
    ...
    void setUp(){
        try{
            ...
            stmt.executeUpdate("insert into engineering_core values('CS302',3,2020);");
    ...
    void tearDown() {
        try{
            ...
            stmt.executeUpdate("delete from engineering_core where course_id='CS302';");
