...
class Student_home_pageTest12_1 {
    ...
    Student_home_pageTest12_1() throws SQLException {
    }
    @BeforeEach
    void setUp() {
        try{
            ...
            stmt.executeUpdate("insert into course_catalog values('CP302','BTP','All','3-1-2-6-3','{\"NIL\"}')on conflict(courseid) do nothing;");
            ...
            stmt.executeUpdate("insert into all_student_data values('2020CSB1103','2023-1',2020,'CP302','A',7,'PC');");
