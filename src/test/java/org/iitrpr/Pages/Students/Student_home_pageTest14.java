...
class Student_home_pageTest14 {
    ...
    Student_home_pageTest14() throws SQLException {
    }
    @BeforeEach
    void setUp() {
        try{
            ...
            /*stmt.executeUpdate("insert into all_student_data values('2020CSB1101','2023-2',2020,'CS500','A',8,'PC');");*/
