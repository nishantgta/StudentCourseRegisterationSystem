...
class Student_home_pageTest9 {
    ...
    Student_home_pageTest9() throws SQLException {
    }
    @BeforeEach
    void setUp() {
        try{
            stmt.executeUpdate("insert into elective values('GE105','2021-2',2020,'Mechanical Engineering');");
    ...
    void register_electives() {
        ...
        Student_home_page.register_electives("2020csb1103@iitrpr.ac.in",stmt,3,"Computer Science and Engineering",2020,conn,"2021-2",sc);
    }
